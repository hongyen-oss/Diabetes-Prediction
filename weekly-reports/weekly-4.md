...
|      Hạng mục                                |   Trạng thái        |   %  |
|----------------------------------------------|---------------------|------|
| Lưu full Pipeline + Metadata                 | Đã hoàn thành thành | 100% |
| Demo load + predict                          | Đã hoàn thành thành | 100% |
| Hỗ trợ lưu full Pipeline                     | Đã hoàn thành thành | 100% |
...
| Võ Hồng Yến           | Frontend           |
| Nguyễn Lê Duy Vương   | Backend/API        |
| Nguyễn Huỳnh Như Ý    | Backend (Database) |
